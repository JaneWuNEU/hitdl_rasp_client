...
def create_users(user_list,model_details):
    ...
    return user_list,activate_flag_list,recv_port_list,request_records_list
    ...
    while True:
        if edge_notice_ev.is_set():
            ...
            if edge_notice['type'] == 'create':
                ...
                # 2. create users
                del user_list
                user_list,activate_flag_list,recv_port_list,request_records_list = create_users([],edge_notice['model_details'])
